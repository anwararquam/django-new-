...
e2=Entry(root)
e2.insert(0, "eg. Jhon@abc.com")
e2.bind("<FocusIn>",temp_text)
...
def submit():
    ...
    e3.delete(0,"end")
    e4.delete(0,"end")
mybut=Button(root,text="Submit",command=submit).grid(row=6,column=2,padx= 5, pady= 8)
root.mainloop()
